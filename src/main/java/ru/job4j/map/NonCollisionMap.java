...
public class NonCollisionMap<K, V> implements SimpleMap<K, V> {
    ...
    private boolean isKeyEquals(K key, MapEntry<K, V> entry, int hash) {
        return entry != null && (hash(Objects.hashCode(entry.key)) == hash && entry.key == key
